...
const validationSchema = Yup.object({
  ...
  phone: Yup.string()
    .matches(/^[0-9+\s-]+$/, 'Phone number can only contain digits, spaces, hyphens, and +')
    .required('Required'),
...
export default function SponsorForm() {
  ...
  // Handle sponsor name - only letters, spaces, hyphens, apostrophes
  const handleSponsorNameChange = (e) => {
    const value = e.target.value;
    const filtered = value.replace(/[^a-zA-Z\s'-]/g, '');
    formik.setFieldValue('sponsorName', filtered);
  };
  ...
  // Handle sponsor amount - only numbers and decimal
  const handleAmountChange = (e) => {
    const value = e.target.value;
    const filtered = value.replace(/[^0-9.]/g, '');
    const parts = filtered.split('.');
    const formatted = parts.length > 2 ? parts[0] + '.' + parts.slice(1).join('') : filtered;
    formik.setFieldValue('sponsorAmount', formatted);
  };
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">Numbers only (spaces, hyphens, and + allowed)</p>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">Numbers only (decimal allowed)</p>
                        </div>
                      </div>
                    </div>
