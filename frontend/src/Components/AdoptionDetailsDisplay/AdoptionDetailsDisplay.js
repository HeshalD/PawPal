          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 mb-8">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                  <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent mb-2 flex items-center gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={handlePrint}
                    className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white px-6 py-3 rounded-xl font-medium flex items-center gap-2 transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
                    <FileText size={20} />
                    Print All Records
                  </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-6 gap-6 mb-8">
              <div className="lg:col-span-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-white rounded-xl border-2 border-transparent focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-all duration-200 shadow-sm"
                  />
                </div>
              </div>
              ...
              <div className="lg:col-span-2">
                <select
                  ...
                  className="w-full px-4 py-4 bg-white rounded-xl border-2 border-transparent focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-all duration-200 shadow-sm"
                >
                      ...
                      <div className="flex flex-col gap-4">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                          <div>
                            ...
                            <p className="text-purple-100">Submitted by {item.fullName}</p>
                        ...
                        <div className="space-y-6">
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-all duration-200"
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-semibold text-purple-600 mb-2">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              onChange={onEditChange}
                              rows={3}
                              className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-all duration-200 resize-none"
                            />
                          </div>
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div>
                          ...
                          <div className="flex gap-3 pt-4">
                            <button
                              ...
                              className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white px-6 py-3 rounded-xl font-medium flex items-center gap-2 transition-all duration-200 shadow-lg"
                            >
                              <Save size={16} />
                              Save Changes
                            </button>
                            <button
                              onClick={cancelEdit}
                              className="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-xl font-medium flex items-center gap-2 transition-all duration-200"
                            >
                              <X size={16} />
                              Cancel
                            </button>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                              {item.selectedPets && item.selectedPets.length > 0 ? (
                                item.selectedPets.map((pet, petIndex) => (
                                  <div key={petIndex} className="bg-white p-3 rounded-lg shadow-sm border border-purple-200">
                            ...
                            {item.salarySheet ? (
                              <div className="flex flex-wrap gap-3">
                                <button
                                  ...
                                  className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white px-4 py-2 rounded-xl font-medium flex items-center gap-2 transition-all duration-200"
                                >
                                  <Eye size={16} />
                                  View PDF
                                </button>
                                <button
                                  ...
                                  className="bg-gradient-to-r from-pink-600 to-purple-500 hover:from-pink-700 hover:to-purple-600 text-white px-4 py-2 rounded-xl font-medium flex items-center gap-2 transition-all duration-200"
                                >
                                  <Download size={16} />
                                  Download
                                </button>
          ...
          {selectedPdf && (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
              <div className="bg-white rounded-3xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
                <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-purple-600 to-pink-500">
                  <h3 className="text-xl font-bold text-white">Salary Sheet Document</h3>
                  <button
                    onClick={closePdfViewer}
                    className="bg-white/20 hover:bg-white/30 backdrop-blur-sm p-2 rounded-lg transition-all duration-200 text-white"
                  >
                    <X size={20} />
                  </button>
                </div>
