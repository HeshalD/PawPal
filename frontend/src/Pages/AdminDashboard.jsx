  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const endpoints = [
        ...
        { name: 'inventory', url: `${API_BASE_URL}/items` }
      ];
      ...
      responses.forEach((response, index) => {
        ...
        if (response.status === 'fulfilled') {
          ...
          if (endpointName === 'inventory') {
            ...
            console.log('Inventory data:', dataMap[endpointName]); // Debug log
          } else {
      ...
      console.log('Processed inventory array:', inventory); // Debug log
      ...
      console.log('Inventory stats:', { lowStockItems, outOfStockItems, inStockItems, total: inventory.length }); // Debug log
        ...
        <div className="min-h-screen bg-gray-50 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all relative">
