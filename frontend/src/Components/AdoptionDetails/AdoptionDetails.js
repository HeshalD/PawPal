        ...
        <>
          <style jsx>{`
            ...
            .pet-card:hover {
              ...
              box-shadow: 0 10px 20px rgba(230, 115, 143, 0.2);
            }
            .pet-card.selected {
              border-color: #6638E6;
              background-color: #f3f0ff;
              box-shadow: 0 8px 16px rgba(102, 56, 230, 0.3);
            }
            .pet-card img {
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="space-y-6">
                      ...
                      {loadingPets ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="pet-card p-0 rounded-xl">
                              <div className="loading-skeleton h-48 rounded-t-xl"></div>
                        ...
                        <div className="text-center py-12 text-gray-500">
                          ...
                          <p className="text-lg">No pets available at the moment.</p>
