...
export default function AppointmentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              <div className="flex justify-between items-center py-6">
                ...
                <div className="flex space-x-4">
                  <Link to="/appointmentform">
                    <button className="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl">
                      <Plus className="w-5 h-5" />
                      <span>Book Appointment</span>
                    </button>
                  </Link>
                  <button onClick={loadAppointments} className="flex items-center space-x-2 px-4 py-2 bg-white border-2 border-purple-500 text-purple-600 rounded-lg hover:bg-purple-50 transition-all duration-200">
                    <RefreshCw className="w-4 h-4" />
                    <span>Refresh</span>
                  </button>
                  <button onClick={downloadReport} className="flex items-center space-x-2 px-4 py-2 bg-white border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all duration-200">
                      ...
                      <div className="p-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-4">
                            <span className={`inline-flex px-4 py-2 text-sm font-semibold rounded-full ${isUpcoming ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                              {isUpcoming ? 'Upcoming' : 'Past'}
                            </span>
                            <button onClick={() => editAppointment(appointment._id)} className="p-2 text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition-all duration-200" title="Edit">
                              <Edit className="w-4 h-4" />
                            </button>
                            <button onClick={() => cancelAppointment(appointment._id)} className="p-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-all duration-200" title="Delete">
      ...
      <HealthcareChatbot role="user" context="appointments dashboard" />
    </div>
  );
}